...
const trainButton = document.getElementById('train') as HTMLInputElement;
const testButton = document.getElementById('test') as HTMLInputElement;
const iterationStatus = document.getElementById('iteration-status');
const iterationProgress = document.getElementById('iteration-progress') as HTMLInputElement;
const trainStatus = document.getElementById('train-status');
const trainSpeed = document.getElementById('train-speed');
const trainProgress = document.getElementById('train-progress') as HTMLInputElement;
...
export async function setUpUI() {
  ...
  if (await SaveablePolicyNetwork.checkStoredModelStatus() != null) {
    ...
    policyNet = new SaveablePolicyNetwork([3]);
  }
